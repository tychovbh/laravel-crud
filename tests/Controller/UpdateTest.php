...
class UpdateTest extends TestCase
{
    ...
    public function itCanUpdate()
    {
        ...
        $this->putJson(route('users.update', ['model' => $user->id]), $update->toArray())
            ->assertStatus(200)
            ->assertJson([
                'data' => $expected
            ]);
    ...
    public function itCanStoreDetectResource()
    {
        ...
        $this->putJson(route('posts.update', ['model' => $post->id]), $update->toArray())
            ->assertStatus(200)
            ->assertExactJson([
                'data' => [
                    'title' => $update->title,
    ...
    public function itCantUpdate()
    {
        ...
        $this->putJson(route('users.update', ['model' => $user->id]), ['email' => 'test'])
            ->assertStatus(422)
            ->assertJson([
